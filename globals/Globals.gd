...
enum SortSimilarity { AVERAGED, AVERAGE, DIFFERENCE, WAVELET }
...
enum Sort {
	...
	YELLOW, LIGHT_YELLOW, DARK_YELLOW, CYAN, LIGHT_CYAN, DARK_CYAN, FUSCHIA, LIGHT_FUSCHIA, DARK_FUSCHIA, LIGHT, DARK, 
	ALPHA, RANDOM
}
