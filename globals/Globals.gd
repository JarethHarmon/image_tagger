...
enum Colors { RED, GREEN, BLUE, YELLOW, CYAN, FUCHSIA, VIVID, NEUTRAL, DULL, LIGHT, MEDIUM, DARK, ALPHA }
...
enum SortSimilarity { AVERAGED, AVERAGE, DIFFERENCE, WAVELET, PERCEPTUAL, COLOR }
enum Order { ASCENDING, DESCENDING }
enum Sort {
	HASH, PATH, NAME, SIZE, UPLOAD, CREATION, LAST_WRITE, LAST_EDIT, DIMENSIONS, WIDTH, HEIGHT, TAG_COUNT,
	NUM_FRAMES, QUALITY, APPEAL, ART_STYLE, COLOR, RANDOM
}
